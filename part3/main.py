...
class Menu:
    ...
    def run(self):
        ...
        while running:
            ...
            action_y3 = 430
            train_both_btn = self.draw_button("Train Both", 50, action_y3, 240, 50)

            # Instructions
            info_y = 500
            instructions = [
                "MODES:",
                "  Play - Manual control    Train - PPO training",
                "  Demo - Watch agent       Load Model - Load saved model",
                "  TensorBoard - Dashboard  View Graphs - Training curves",
                "",
                "CONTROLS:",
                "  Rotation: UP=Thrust, LEFT/RIGHT=Rotate, SPACE=Shoot",
                "  Directional: Arrow keys to move, SPACE=Shoot",
                "",
